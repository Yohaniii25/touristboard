...
$colombo_experiences = showcolomboexperiences();
$colombo_experiences_Seethawaka = showcolomboexperiences_seethawaka();
$colombo_experiences_Beach = showcolomboexperiences_beach();
$showcolomboexperiences_colonial = showcolomboexperiences_colonial();
$showcolomboexperiences_mice = showcolomboexperiences_mice();
...
<body>
    ...
    <div class="page">
        ...
        <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(./images/home/new_bread.jpg);" data-preset='{"title":"Breadcrumbs","category":"header","reload":false,"id":"breadcrumbs"}'>
            <div class="container">
                ...
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active">Colombo Experiences</li>
                </ul>
            </div>
        </section>
        ...
        <section class="section section-lg bg-default">
            <div class="container">
                <h2 class="text-center text-md-start">Explore Top Destination Around Colombo</h2>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12 col-xl-12">
                                    ...
                                    <div class="card-group-custom card-group-corporate" id="accordion1" role="tablist" aria-multiselectable="false">
                                        ...
                                        <article class="card card-custom card-corporate">
                                            ...
                                            <div class="collapse show" id="accordion1-card-body-lrdexjyp" aria-labelledby="accordion1-card-head-xxtgcvny" data-bs-parent="#accordion1" role="tabpanel">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <?php
                                                        while ($row = mysqli_fetch_assoc($colombo_experiences_Seethawaka)) {
                                                            echo "
                                        ...
                                        <article class="card card-custom card-corporate">
                                            <div class="card-header" role="tab">
                                                <div class="card-title"><a class="collapsed" id="accordion1-card-head-eoubxcjv" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#accordion1-card-body-cjtxsisg" aria-controls="accordion1-card-body-cjtxsisg" aria-expanded="false" role="button">Beach Tourism
                                            ...
                                            <div class="collapse" id="accordion1-card-body-cjtxsisg" aria-labelledby="accordion1-card-head-eoubxcjv" data-bs-parent="#accordion1" role="tabpanel">
                                                ...
                                                <div class="row">
                                                        <?php
                                                        while ($row = mysqli_fetch_assoc($colombo_experiences_Beach)) {
                                                            echo "
                                                            <div class='col-lg-4 col-md-6 mb-4'>
                                                            <div class='service-box-creative'>
                                                            <a class='service-box-creative__media zoom' href='single_package.php?exp_id=" . $row['exp_id'] . "' style='position: relative; display: block;'>
                                        ...
                                        <article class="card card-custom card-corporate">
                                            <div class="card-header" role="tab">
                                                <div class="card-title"><a class="collapsed" id="accordion1-card-head-ufmayvae" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#accordion1-card-body-bvlwjyvx" aria-controls="accordion1-card-body-bvlwjyvx" aria-expanded="false" role="button">Colonial Tourism
                                                        <div class="card-arrow"></div>
                                                    </a></div>
                                            </div>
                                            <div class="collapse" id="accordion1-card-body-bvlwjyvx" aria-labelledby="accordion1-card-head-ufmayvae" data-bs-parent="#accordion1" role="tabpanel">
                                                ...
                                                <div class="row">
                                                        <?php
                                                        while ($row = mysqli_fetch_assoc($showcolomboexperiences_colonial)) {
                                                            echo "
                                                            <div class='col-lg-4 col-md-6 mb-4'>
                                                            <div class='service-box-creative'>
                                                            <a class='service-box-creative__media zoom' href='single_package.php?exp_id=" . $row['exp_id'] . "' style='position: relative; display: block;'>
                                        ...
                                        <article class="card card-custom card-corporate">
                                            <div class="card-header" role="tab">
                                                <div class="card-title"><a class="collapsed" id="accordion1-card-head-atqimhsc" data-bs-toggle="collapse" data-bs-parent="#accordion1" href="#accordion1-card-body-sgrucddt" aria-controls="accordion1-card-body-sgrucddt" aria-expanded="false" role="button">Mice Tourism
                                                        <div class="card-arrow"></div>
                                                    </a></div>
                                            </div>
                                            <div class="collapse" id="accordion1-card-body-sgrucddt" aria-labelledby="accordion1-card-head-atqimhsc" data-bs-parent="#accordion1" role="tabpanel">
                                                ...
                                                <div class="row">
                                                        <?php
                                                        while ($row = mysqli_fetch_assoc($showcolomboexperiences_mice)) {
                                                            echo "
                                                            <div class='col-lg-4 col-md-6 mb-4'>
                                                            <div class='service-box-creative'>
                                                            <a class='service-box-creative__media zoom' href='single_package.php?exp_id=" . $row['exp_id'] . "' style='position: relative; display: block;'>
