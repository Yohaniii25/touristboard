      ...
      <div class="">
        ...
        <div class="row">
                 ...
                 <?php
                    ...
                    while ($row = mysqli_fetch_assoc($rand_dest)) {
                      // echo $row['dest_name'];
                      echo '
                      <div class="col-3">
                                    <a class="info-box-classic" href="destination.php?destid='.$row['id'].'" contenteditable="false" style="cursor: pointer;">

                                <img src="images/tour/'.$row['image_path'].'" alt="" width="370" height="240">

                                <div class="info-box-classic__description">

                                  <div class="heading-4">'.$row['dest_name'].'</div>
